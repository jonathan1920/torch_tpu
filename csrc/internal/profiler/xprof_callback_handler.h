...
#ifndef TORCH_TPU_CSRC_INTERNAL_PROFILER_XPROF_CALLBACK_HANDLER_H_
#define TORCH_TPU_CSRC_INTERNAL_PROFILER_XPROF_CALLBACK_HANDLER_H_
...
#endif  // TORCH_TPU_CSRC_INTERNAL_PROFILER_XPROF_CALLBACK_HANDLER_H_
