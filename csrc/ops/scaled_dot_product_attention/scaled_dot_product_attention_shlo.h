...
#ifndef TORCH_TPU_CSRC_OPS_SCALED_DOT_PRODUCT_ATTENTION_SCALED_DOT_PRODUCT_ATTENTION_SHLO_H_
#define TORCH_TPU_CSRC_OPS_SCALED_DOT_PRODUCT_ATTENTION_SCALED_DOT_PRODUCT_ATTENTION_SHLO_H_
...
struct FusedAttentionResults {
  at::Tensor output;     // UNINITIALIZED_TENSOR_OK
  at::Tensor logsumexp;  // UNINITIALIZED_TENSOR_OK
};
...
#endif  // TORCH_TPU_CSRC_OPS_SCALED_DOT_PRODUCT_ATTENTION_SCALED_DOT_PRODUCT_ATTENTION_SHLO_H_
