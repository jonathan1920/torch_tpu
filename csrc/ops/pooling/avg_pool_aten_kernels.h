...
#ifndef TORCH_TPU_CSRC_OPS_POOLING_AVG_POOL_ATEN_KERNELS_H_
#define TORCH_TPU_CSRC_OPS_POOLING_AVG_POOL_ATEN_KERNELS_H_
...
#endif  // TORCH_TPU_CSRC_OPS_POOLING_AVG_POOL_ATEN_KERNELS_H_
