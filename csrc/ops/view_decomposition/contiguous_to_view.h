...
#ifndef TORCH_TPU_CSRC_OPS_VIEW_DECOMPOSITION_CONTIGUOUS_TO_VIEW_H_
#define TORCH_TPU_CSRC_OPS_VIEW_DECOMPOSITION_CONTIGUOUS_TO_VIEW_H_
...
#endif  // TORCH_TPU_CSRC_OPS_VIEW_DECOMPOSITION_CONTIGUOUS_TO_VIEW_H_
