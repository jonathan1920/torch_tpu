...
#ifndef TORCH_TPU_CSRC_OPS_INDEX_PUT_INDEX_PUT_ATEN_KERNELS_H_
#define TORCH_TPU_CSRC_OPS_INDEX_PUT_INDEX_PUT_ATEN_KERNELS_H_
...
#endif  // TORCH_TPU_CSRC_OPS_INDEX_PUT_INDEX_PUT_ATEN_KERNELS_H_
