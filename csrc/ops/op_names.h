...
enum class OpName {
  ...
  kBinCount,
  kBinaryCrossEntropy,
  kBinaryCrossEntropyBackward,
  kBinaryCrossEntropyBackwardGradInput,
  ...
  kMaskedSelectSize,
  kMaskedSoftmax,
  kMaskedSoftmaxBackward,
  kMaskedSoftmaxBackwardOut,
  kMaskedSoftmaxOut,
  kMax,
  kMaxDimMax,
  kMaxPool2d,
  ...
  kNeTensorOut,
  kNegOut,
  kNestedFromPaddedTensor,
  kNestedGetJaggedDummy,
  kNestedGetLengths,
  kNestedGetMaxSeqlen,
  kNestedGetMinSeqlen,
  kNestedGetOffsets,
  ...
  kTanhOut,
  kThnnFusedGruCell,
  kThnnFusedGruCellBackward,
  kThnnFusedGruCellOut,
  kThnnFusedLstmCell,
  kThnnFusedLstmCellBackwardImpl,
  kThnnFusedLstmCellOut,
