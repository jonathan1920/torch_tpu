...
#ifndef TORCH_TPU_CSRC_OPS_LINALG_VECTOR_NORM_PNORM_H_
#define TORCH_TPU_CSRC_OPS_LINALG_VECTOR_NORM_PNORM_H_
...
#endif  // TORCH_TPU_CSRC_OPS_LINALG_VECTOR_NORM_PNORM_H_
