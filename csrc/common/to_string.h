...
#ifndef TORCH_TPU_CSRC_COMMON_TO_STRING_H_
#define TORCH_TPU_CSRC_COMMON_TO_STRING_H_
...
template <typename T1, typename T2>
[[nodiscard]] std::string ToString(
    const std::pair<T1, T2>& pair) {  // STD_PAIR_OK=generic ToString helper
...
#endif  // TORCH_TPU_CSRC_COMMON_TO_STRING_H_
