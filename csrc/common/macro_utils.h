...
//
//   - "third_party/py/torch_tpu/" directory (Google3)
//   - "csrc/" directory (OSS)
//
// As an example, this function translates (1) into (2):
//
//   1.
//   bazel-out/k8-fastbuild/bin/csrc/ops/_virtual_includes/op_builder_utils/csrc/ops/op_builder_utils.h
//
//   2.
//   csrc/ops/op_builder_utils.h
//
// If `path` does not start with "bazel-out" or "blaze-out" directory, and
// contains either "third_party/py/torch_tpu/" or "csrc/" directory, this
// function returns `path` untouched.
//
