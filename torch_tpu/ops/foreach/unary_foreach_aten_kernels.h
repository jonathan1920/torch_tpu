...
#ifndef TORCH_TPU_OPS_FOREACH_UNARY_FOREACH_ATEN_KERNELS_H_
#define TORCH_TPU_OPS_FOREACH_UNARY_FOREACH_ATEN_KERNELS_H_
...
#endif  // TORCH_TPU_OPS_FOREACH_UNARY_FOREACH_ATEN_KERNELS_H_
