...
#ifndef TORCH_TPU_CSRC_COMMON_ERROR_UTILS_H_
#define TORCH_TPU_CSRC_COMMON_ERROR_UTILS_H_
...
#include "torch_tpu/csrc/ops/python_context.h"  // IWYU pragma: keep
...
inline constexpr absl::StatusCode kAborted =
    absl::StatusCode::kAborted;  // STATUS_CODE_OK=for alias
inline constexpr absl::StatusCode kAlreadyExists =
    absl::StatusCode::kAlreadyExists;  // STATUS_CODE_OK=for alias
inline constexpr absl::StatusCode kCancelled =
    absl::StatusCode::kCancelled;  // STATUS_CODE_OK=for alias
inline constexpr absl::StatusCode kDataLoss =
    absl::StatusCode::kDataLoss;  // STATUS_CODE_OK=for alias
...
inline constexpr absl::StatusCode kInternal =
    absl::StatusCode::kInternal;  // STATUS_CODE_OK=for alias
inline constexpr absl::StatusCode kInvalidArgument =
    absl::StatusCode::kInvalidArgument;  // STATUS_CODE_OK=for alias
inline constexpr absl::StatusCode kNotFound =
    absl::StatusCode::kNotFound;  // STATUS_CODE_OK=for alias
inline constexpr absl::StatusCode kOk =
    absl::StatusCode::kOk;  // STATUS_CODE_OK=for alias
...
inline constexpr absl::StatusCode kUnavailable =
    absl::StatusCode::kUnavailable;  // STATUS_CODE_OK=for alias
// go/keep-sorted end
...
#endif  // TORCH_TPU_CSRC_COMMON_ERROR_UTILS_H_
