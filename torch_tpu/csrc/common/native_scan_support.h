...
#ifndef TORCH_TPU_CSRC_COMMON_NATIVE_SCAN_SUPPORT_H_
#define TORCH_TPU_CSRC_COMMON_NATIVE_SCAN_SUPPORT_H_
...
#endif  // TORCH_TPU_CSRC_COMMON_NATIVE_SCAN_SUPPORT_H_
