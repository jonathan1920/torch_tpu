...
#ifndef TORCH_TPU_OPS_BADDBMM_BADDBMM_ATEN_KERNELS_H_
#define TORCH_TPU_OPS_BADDBMM_BADDBMM_ATEN_KERNELS_H_
...
#endif  // TORCH_TPU_OPS_BADDBMM_BADDBMM_ATEN_KERNELS_H_
