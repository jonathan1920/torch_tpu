...
#ifndef TORCH_TPU_CSRC_OPS_SCATTER_SCATTER_ATEN_KERNELS_H_
#define TORCH_TPU_CSRC_OPS_SCATTER_SCATTER_ATEN_KERNELS_H_
...
#endif  // TORCH_TPU_CSRC_OPS_SCATTER_SCATTER_ATEN_KERNELS_H_
