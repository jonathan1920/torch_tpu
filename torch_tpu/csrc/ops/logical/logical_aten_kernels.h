...
#ifndef TORCH_TPU_CSRC_OPS_LOGICAL_LOGICAL_ATEN_KERNELS_H_
#define TORCH_TPU_CSRC_OPS_LOGICAL_LOGICAL_ATEN_KERNELS_H_
...
#endif  // TORCH_TPU_CSRC_OPS_LOGICAL_LOGICAL_ATEN_KERNELS_H_
