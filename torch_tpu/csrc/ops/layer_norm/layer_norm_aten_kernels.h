...
#ifndef TORCH_TPU_CSRC_OPS_LAYER_NORM_LAYER_NORM_ATEN_KERNELS_H_
#define TORCH_TPU_CSRC_OPS_LAYER_NORM_LAYER_NORM_ATEN_KERNELS_H_
...
#endif  // TORCH_TPU_CSRC_OPS_LAYER_NORM_LAYER_NORM_ATEN_KERNELS_H_
