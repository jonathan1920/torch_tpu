...
#ifndef TORCH_TPU_CSRC_OPS_COPY_FROM_COPY_FROM_ATEN_KERNELS_H_
#define TORCH_TPU_CSRC_OPS_COPY_FROM_COPY_FROM_ATEN_KERNELS_H_
...
#endif  // TORCH_TPU_CSRC_OPS_COPY_FROM_COPY_FROM_ATEN_KERNELS_H_
