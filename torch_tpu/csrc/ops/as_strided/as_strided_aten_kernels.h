...
#ifndef TORCH_TPU_CSRC_OPS_AS_STRIDED_AS_STRIDED_ATEN_KERNELS_H_
#define TORCH_TPU_CSRC_OPS_AS_STRIDED_AS_STRIDED_ATEN_KERNELS_H_
...
#endif  // TORCH_TPU_CSRC_OPS_AS_STRIDED_AS_STRIDED_ATEN_KERNELS_H_
