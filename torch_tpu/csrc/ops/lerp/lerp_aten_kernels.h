...
#ifndef TORCH_TPU_CSRC_OPS_LERP_LERP_ATEN_KERNELS_H_
#define TORCH_TPU_CSRC_OPS_LERP_LERP_ATEN_KERNELS_H_
...
#endif  // TORCH_TPU_CSRC_OPS_LERP_LERP_ATEN_KERNELS_H_
