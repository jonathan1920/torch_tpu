...
#ifndef TORCH_TPU_CSRC_OPS_VIEW_DECOMPOSITION_BROADCAST_PRIMITIVE_H_
#define TORCH_TPU_CSRC_OPS_VIEW_DECOMPOSITION_BROADCAST_PRIMITIVE_H_
...
#endif  // TORCH_TPU_CSRC_OPS_VIEW_DECOMPOSITION_BROADCAST_PRIMITIVE_H_
