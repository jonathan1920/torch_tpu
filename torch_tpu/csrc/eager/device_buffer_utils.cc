...
#include "torch_tpu/csrc/common/layout_utils.h"
...
#include "torch_tpu/csrc/eager/repeated_ops_heuristic.h"
...
#include "torch_tpu/csrc/ops/stride/stride_helper.h"
...
absl::StatusOr<DeviceBufferRef> CreateConstantDeviceBufferRefImpl(
  ...
  TT_ASSIGN_OR_RETURN(auto op_param_cache_keys,
                      internal::ComputeConstantDeviceBufferRefOpParamCacheKeys(
                          cpu_tensor_data, dimensions, element_type));
