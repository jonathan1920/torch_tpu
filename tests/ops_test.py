...
ACCURACY_OVERRIDES_VS_GPU = {
    ...
    "_foreach_atan": {
        torch.complex64: {"rtol": 1.9e-5, "atol": 1.5e-5},
    },
    "_foreach_cos": {
        torch.complex64: {"rtol": 3.6e-6, "atol": 1e-2},
    },
    "_foreach_cosh": {
        torch.complex64: {"rtol": 5.1e-6},
        torch.float32: {"rtol": 5e-6},
    ...
    "_foreach_exp": {
        ...
        torch.float32: {"rtol": 4.9e-6},
        torch.int16: {"rtol": 4.4e-6, "atol": 7.9e-7},
        torch.int32: {"rtol": 4.4e-6, "atol": 7.9e-7},
        torch.int64: {"rtol": 4.4e-6, "atol": 7.9e-7},
        torch.int8: {"rtol": 4.4e-6, "atol": 7.9e-7},
        torch.uint8: {"rtol": 4.4e-6},
    },
    "_foreach_expm1": {
        torch.complex64: {"rtol": 5.9e-6},
        torch.float32: {"rtol": 6.3e-6},
        torch.int16: {"rtol": 4.4e-6, "atol": 7.9e-7},
        torch.int32: {"rtol": 4.4e-6, "atol": 7.9e-7},
        torch.int64: {"rtol": 4.4e-6, "atol": 7.9e-7},
        torch.int8: {"rtol": 4.4e-6, "atol": 7.9e-7},
    ...
    "cdist": {
        torch.bfloat16: {"atol": 2.1e-1},
        torch.float16: {"rtol": 2e-1, "atol": 3e-1},
        torch.float32: {"rtol": 5.1e-1, "atol": 3e-1},
    },
    "cos": {
        torch.complex64: {"rtol": 4.5e-6},
    },
    "cosh": {
        torch.complex64: {"rtol": 3.9e-6},
        torch.float32: {"rtol": 3.4e-6},
        torch.int16: {"rtol": 4e-6},
        torch.int32: {"rtol": 4e-6},
        torch.int64: {"rtol": 4e-6},
        torch.int8: {"rtol": 4e-6},
    ...
    "digamma": {
        ...
        torch.int16: {"rtol": 4.7e-5, "atol": 4.3e-7},
        torch.int32: {"rtol": 4.7e-5, "atol": 4.3e-7},
        torch.int64: {"rtol": 4.7e-5, "atol": 4.3e-7},
        torch.int8: {"rtol": 4.7e-5, "atol": 4.3e-7},
        torch.uint8: {"rtol": 4.7e-5, "atol": 3.6e-5},
    },
    "erfinv": {
        torch.float32: {"rtol": 1.6e-5, "atol": 1.7e-5},
    },
    "exp": {
        torch.complex64: {"rtol": 2.8e-6},
        torch.float32: {"rtol": 4.6e-6},
        torch.int16: {"rtol": 3.1e-6, "atol": 7.9e-7},
        torch.int32: {"rtol": 3.1e-6, "atol": 7.9e-7},
        torch.int64: {"rtol": 3.1e-6, "atol": 7.9e-7},
        torch.int8: {"rtol": 3.1e-6, "atol": 7.9e-7},
        torch.uint8: {"rtol": 4.4e-6},
    },
    "exp2": {
        torch.bfloat16: {"rtol": 2.4e-2, "atol": 2.4e-3},
        torch.complex64: {"rtol": 3.3e-6},
        torch.float16: {"rtol": 2.3e-3, "atol": 5.9e-4},
        torch.float32: {"rtol": 2.4e-6},
    },
    "expm1": {
        torch.complex64: {"rtol": 4.7e-6},
        torch.float32: {"rtol": 6.9e-6},
        torch.int16: {"rtol": 4.4e-6, "atol": 7.9e-7},
        torch.int32: {"rtol": 4.4e-6, "atol": 7.9e-7},
        torch.int64: {"rtol": 4.4e-6, "atol": 7.9e-7},
    ...
    "logit": {
        torch.bool: {"atol": 7.5e-5},
        torch.float16: {"atol": 5.9e-4},
        torch.float32: {"rtol": 7.5e-5, "atol": 8.3e-5},
        torch.int16: {"atol": 7.5e-5},
        torch.int32: {"atol": 7.5e-5},
        torch.int64: {"atol": 7.5e-5},
        torch.int8: {"atol": 7.5e-5},
    ...
    "matmul": {
        torch.bfloat16: {"rtol": 1.2e-1, "atol": 1.9e-1},
        torch.complex64: {"rtol": 1.4e-1},
        torch.float16: {"rtol": 3e-1, "atol": 4.7e-1},
        torch.float32: {"rtol": 2.7e-1, "atol": 3.9e-1},
    },
    "mm": {
    ...
    "nn.functional.silu": {
        ...
        torch.float32: {"rtol": 1.3e-5, "atol": 7.2e-5},
    },
    "norm": {
        torch.complex64: {"rtol": 5.7e-6},
        torch.float32: {"rtol": 5.7e-6},
    },
    "polygamma": {
        torch.float32: {"rtol": 1.1e-5},
    },
    "pow": {
        torch.complex64: {"rtol": 7e-4, "atol": 3.8e-4},
...
class TestOps(op_testing.OpInfoTestBase):
  ...
  def test_addmm(self):
    self.do_test_op(
        ...
        # implemented.
        exclude_dtypes={
            # CPU supports int64 for addmm, but TPU rejects it to match GPU.
            "cpu": COMPLEX_DTYPES + (torch.int64,),
            # TODO: make addmm fail for the remaining integral dtypes to match
            # GPU.
            "gpu": (
                COMPLEX_DTYPES
                + (
        ...
        exclude_inplace_dtypes={
            # CPU supports int64 for addmm_, but TPU rejects it to match GPU.
            "cpu": COMPLEX_DTYPES + (torch.int64,),
            "gpu": (
                COMPLEX_DTYPES
                + (
  ...
  def test_addmv(self):
    # TODO: make addmv fail for the remaining integral dtypes to match GPU.
    self.do_test_op(
        "addmv",
        # GPU (CUDA) does not support integral dtypes for addmv.
        exclude_dtypes={
            # CPU supports int64 for addmv, but TPU rejects it to match GPU.
            "cpu": (torch.int64,),
            "gpu": (
                torch.uint8,
                torch.int8,
        ...
        exclude_inplace_dtypes={
            # CPU supports int64 for addmv_, but TPU rejects it to match GPU.
            "cpu": (torch.int64,),
            "gpu": (
                torch.uint8,
                torch.int8,
  ...
  def test_avg_pool2d(self):
    self.do_test_op(
        "nn.functional.avg_pool2d",
        # CPU supports int64 for avg_pool2d, but TPU rejects it to match GPU.
  ...
  def test_avg_pool3d(self):
    self.do_test_op(
        ...
        exclude_dtypes={
            # CPU supports int64 for avg_pool3d, but TPU rejects it to match
            # GPU.
            "cpu": (torch.int64,),
            "gpu": (
  ...
  def test_baddbmm(self):
    self.do_test_op(
        ...
        exclude_dtypes={
            # CPU supports int64 for baddbmm, but TPU rejects it to match GPU.
        ...
        exclude_inplace_dtypes={
            # CPU supports int64 for baddbmm_, but TPU rejects it to match GPU.
            "cpu": (torch.bool, torch.int64),
            "gpu": (
                torch.uint8,
                torch.int8,
  ...
  def test_bmm(self):
    self.do_test_op(
        ...
        exclude_dtypes={
            # CPU supports int64 for bmm, but TPU rejects it to match GPU.
            "cpu": (torch.int64,),
            "gpu": (
                torch.uint8,
                torch.int8,
  ...
  def test_dot(self):
    self.do_test_op(
        ...
        exclude_dtypes={
            # CPU supports int64 for dot, but TPU rejects it to match GPU.
            "cpu": (torch.int64,),
            "gpu": (
                torch.uint8,
                torch.int8,
  ...
  def test_foreach_div(self):
    self.do_test_op(
        ...
        exclude_inplace_dtypes={
            "cpu": INTEGRAL_DTYPES + COMPLEX_DTYPES,
            # int64 is not excluded on GPU: both GPU and TPU reject in-place
            # division on int64 tensors, whose result type promotes to float.
            "gpu": (
                (
                    torch.uint8,
                    torch.int8,
    ...
    self.do_test_op(
        ...
        exclude_dtypes={
            ...
            "gpu": (
                ...
                # TODO: b/476417319 reject the remaining integer dtypes in the
                # TPU implementation, so that it matches the GPU implementation.
                + (
                    torch.uint8,
                    torch.int8,
                    torch.int16,
  ...
  def test_scaled_mm_v2(self):
    self.do_test_op(
        ...
        exclude_dtypes={
            "cpu": NUMERIC_DTYPES,
            # The op's sample generator always produces float8 matrices, so
            # the int64-keyed GPU golden samples run the float8 path and are
            # expected to succeed.
            "gpu": tuple(
                dtype for dtype in NUMERIC_DTYPES if dtype != torch.int64
            ),
        },
    )
  ...
  def test_vdot(self):
    self.do_test_op(
        ...
        exclude_dtypes={
            # CPU supports int64 for vdot, but TPU rejects it to match GPU.
            "cpu": (torch.int64,),
            "gpu": (
                torch.uint8,
                torch.int8,
