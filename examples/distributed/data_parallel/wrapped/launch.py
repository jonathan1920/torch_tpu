...
"""A test runner for the wrapped data parallel example."""

from torch.google import distributed as gdist
import torch.multiprocessing as mp
from torch_tpu._internal.distributed.launchers import singlehost_wrapper
from examples.distributed.data_parallel.wrapped import dp_worker
...
def main(_):
  ...
  gdist.torchrun(dp_worker.worker_fn, nproc_per_node=8)()
